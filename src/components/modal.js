...
const Modal = ({ contentList, replyList, currentContentId, closeModal, uploadReply, videoRef, stopWebcam}) => {
  ...
  return (
    <div className="fixed inset-0 flex justify-center items-center z-10 pt-8">
      <div className="relative w-2/3 bg-white rounded-lg p-4">
        ...
        {/* close button */}
        <button className="absolute top-2 right-2 text-gray-500" onClick={closeBundleModal}>
          X
        </button>
